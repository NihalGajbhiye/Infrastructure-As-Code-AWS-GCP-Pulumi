...
# Initilaize AWS SES and DynamoDB clients
...
def lambda_handler(event, context):
    ...
    Args:
        event(dict): The event data passsed to the lambda function
    ...
    try:
        ...
        if "Records" in event and len(event("Records")) > 0:
            ...
            try:
                ...
                logger.error(f"Raw message: {event['Record'][0]['Sns']['Message']}")
...
def send_email_zoho(recipient, subject, body):
    try:
        ...
        smtp_port = 587
        smtp_username = os.environ["ZOHO_MAIL"]
    ...
    lambda_handler(
        {
            "Records": [
                {
                    "Sns": {
                        "Message": '{"submission_url": "https://github.com/tparikh/myrepo/archive/refs/tags/v1.0.0.zip", "email": "nihal.gaj@gmail.com"}'
                    }
                }
            ]
        },
